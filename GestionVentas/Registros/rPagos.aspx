<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rPagos.aspx.cs" Inherits="GestionVentas.Registros.rPagos" %>
        ...
        <div class="panel-body">
            <div class="form-horizontal col-md-12" role="form">
                ...
                <div class="form-group">
                    <label for="IdTextBox" class="col-md-3 control-label input-sm">Pago Id: </label>
